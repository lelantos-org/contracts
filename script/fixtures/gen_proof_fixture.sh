...
#
#   gh release download v0.15.0 --repo lelantos-org/circuits -D <dir> \
...
#
#   RELEASE=/path/to/rel0150 CIRCUITS=../circuits \
#     script/fixtures/gen_proof_fixture.sh tree_update_batch
#
...
RELEASE="$(cd "${RELEASE:?set RELEASE to a directory of v0.15.0 release assets}" && pwd)"
